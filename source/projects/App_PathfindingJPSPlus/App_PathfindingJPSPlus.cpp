...
//Includes
#include "App_PathfindingJPSPlus.h"
#include "framework\EliteAI\EliteGraphs\EliteGraphAlgorithms\EJPSPlus.h"
...
//Destructor
App_PathfindingJPSPlus::~App_PathfindingJPSPlus()
{
	SAFE_DELETE(m_pGridGraph);
}

//Functions
void App_PathfindingJPSPlus::Start()
{
	//Set Camera
...
void App_PathfindingJPSPlus::Update(float deltaTime)
{
		...
		&& startPathIdx != endPathIdx)
	{
		...
		//JPSPlus Pathfinding
		auto pathfinder = JPSPlus<GridTerrainNode, GraphConnection>(m_pGridGraph, m_pHeuristicFunction);
...
void App_PathfindingJPSPlus::Render(float deltaTime) const
{
	UNREFERENCED_PARAMETER(deltaTime);
	//Render grid
...
void App_PathfindingJPSPlus::MakeGridGraph()
{
...
void App_PathfindingJPSPlus::UpdateImGui()
{
