...
namespace Elite
{
	...
	{
	public:
		JPSPlus(IGraph<T_NodeType, T_ConnectionType>* pGraph, Heuristic hFunction);
	...
	template <class T_NodeType, class T_ConnectionType>
	JPSPlus<T_NodeType, T_ConnectionType>::JPSPlus(IGraph<T_NodeType, T_ConnectionType>* pGraph, Heuristic hFunction)
		: m_pGraph(pGraph)
	...
	template <class T_NodeType, class T_ConnectionType>
	std::vector<T_NodeType*> JPSPlus<T_NodeType, T_ConnectionType>::FindPath(T_NodeType* pStartNode, T_NodeType* pGoalNode)
	{
	...
	template <class T_NodeType, class T_ConnectionType>
	float Elite::JPSPlus<T_NodeType, T_ConnectionType>::GetHeuristicCost(T_NodeType* pStartNode, T_NodeType* pEndNode) const
	{
