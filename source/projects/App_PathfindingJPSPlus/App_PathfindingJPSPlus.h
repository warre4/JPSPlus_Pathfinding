#ifndef JPSPlus_APPLICATION_H
#define JPSPlus_APPLICATION_H
//-----------------------------------------------------------------
...
// Application
//-----------------------------------------------------------------
class App_PathfindingJPSPlus final : public IApp
{
public:
	//Constructor & Destructor
	App_PathfindingJPSPlus() = default;
	virtual ~App_PathfindingJPSPlus();
...
private:
	...
	App_PathfindingJPSPlus(const App_PathfindingJPSPlus&) = delete;
	App_PathfindingJPSPlus& operator=(const App_PathfindingJPSPlus&) = delete;
};
#endif